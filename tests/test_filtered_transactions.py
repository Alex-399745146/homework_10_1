"""
Файл test_filtered_transactions.py
Содержит кейсы для тестирования модуля filtered_transactions.py.
"""
...
def test_process_bank_operations(fixture_list_operations2: list[dict]) -> None:
    """Тест функции process_bank_operations"""

    result_func = process_bank_operations(fixture_list_operations2, "Перевод организации")
