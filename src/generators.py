...
#         print(
#             f"ID: {currency_name['id']}, Сумма: {currency_name['operationAmount']['amount']} {currency_name['operationAmount']['currency']['name']}")
...
def card_number_generator(start_number, finish_number):
    """
