...
### Модуль <span style="color: red;">data_extractor.py</span>

    В этом модуле реализованы функции считывания финансовых операций из файлов CSV- и XLSX-файлов из data:
        1. Функция считывает данные из CSV
        2. Функция считывает данные из EXCEL
