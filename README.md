...
- [Реализованно обновление данных о курсе валют через API](https://marketplace.apilayer.com/exchangerates_data-api)
- [Используются декораторы, сложные декораторы, Mock, patch]()
- [В проекте применены библиотеки: json, requests, python-dotenv]()
